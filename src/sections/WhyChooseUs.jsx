    ...
    <section className="py-24 md:py-40 bg-secondary relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-20">
          <motion.h2 
            className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-primary mb-6"
        ...
        <div className="space-y-0">
          {reasons.map((reason, i) => (
            ...
            >
              <h3 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-primary/30 group-hover:text-accent transition-colors duration-500 mb-2 md:mb-0 w-full md:w-1/2">
                {reason.title}
              </h3>
